...
static constexpr auto qt_meta_stringdata_ZN5FrameE = QtMocHelpers::stringData(
    "Frame"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN5FrameE[] = {
...
Q_CONSTINIT const QMetaObject Frame::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN5FrameE.offsetsAndSizes,
    qt_meta_data_ZN5FrameE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN5FrameE_t,
        // Q_OBJECT / Q_GADGET
...
void *Frame::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN5FrameE.stringdata0))
