...
public: CalculatorFrame() {
        ...
        label->setFont(QFont("Trebuchet MS", 16));//:З

        label1 = new QLabel("Множество 1", this);
        lineEdit1 = new QLineEdit(this);

        label2 = new QLabel("Множество 2", this);
...
public slots: void onCalculate() {
        ...
        for (int digit : digits2) {
            ...
            resultLabel->setText("Результат: " + QString::fromStdString(result));
    }
